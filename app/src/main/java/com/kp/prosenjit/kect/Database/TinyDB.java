package com.kp.prosenjit.kect.Database;
...
public class TinyDB {
   ...
   public ArrayList<Object> getListObject(String key, Class<?> mClass){
    ...
    public void PutArrayOfarrayList(String key, ArrayList<ArrayList<String>> list){
        checkForNullKey(key);
        Gson gson = new Gson();
    ...
    public ArrayList<ArrayList<String>> getArrayOfArrayList(String key){
        Gson gson = new Gson();
